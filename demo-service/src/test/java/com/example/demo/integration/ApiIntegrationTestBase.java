...
public class ApiIntegrationTestBase {
    ...
    static final MongoDBContainer mongo = new MongoDBContainer("mongo:8.0.3")
            ...
            .withCreateContainerCmdModifier(
                    e -> Objects.requireNonNull(e.getHostConfig())
                            .withPortBindings(new PortBinding(Ports.Binding.bindPort(27018), new ExposedPort(27017)))
            );

    static final GenericContainer<?> kafka = new GenericContainer<>("bitnami/kafka:3.7.0")
            .withEnv(Map.of(
                    "KAFKA_CFG_NODE_ID", "0",
    ...
    static void properties(DynamicPropertyRegistry registry) {
        registry.add("spring.data.mongodb.uri", () -> "mongodb://" + mongo.getHost() + ":27018/task_db");
    }
