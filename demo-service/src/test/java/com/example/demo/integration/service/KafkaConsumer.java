...
public class KafkaConsumer<T> extends Thread {
    ...
    @lombok.Builder.Default private String filter = "";
    @lombok.Builder.Default private int consumingTimeSec = 60;
    @lombok.Builder.Default private boolean waiting = true;
    @lombok.Builder.Default private Map<String, Object> defaultConfig = new HashMap<>(){{
