...
public final class SelenideUtil {
    ...
    // Intentional: triggers SelenideLogger so AllureSelenide captures a screenshot and step
    // The expected text embeds the original timeout message in the Allure report
